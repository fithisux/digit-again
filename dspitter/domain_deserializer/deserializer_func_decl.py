...
def parse_function_decl(some_marker: str, lines: List[str]) -> declaration_type.DeclarationTypeFunction:
    # Let's reduce spaces
    ...
    output_type_simple = deserializer_typedef_type.parse_declaration_type_simple(function_output)
    ...
    if function_args:
        ...
        inputs_type_simple = [deserializer_typedef_type.parse_declaration_type_simple(function_input.strip()) for function_input in function_inputs]
